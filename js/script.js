...
function initializeVisualization(gazeData) {
    // Assuming the JSON structure has a subject field
    const subjectName = gazeData[0].subjectName; // Adjust according to your JSON structure
    document.getElementById('subjectName').innerText = `Subject: ${subjectName}`; // Display subject name
...
function downloadPdf(canvas, imagePath, gazePoints, totalDuration, avgPosition) {
    ...
    // Add a page for the heatmap and gaze paths if needed
    
    // Add any additional analysis or images if necessary
